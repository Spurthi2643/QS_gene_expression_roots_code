...
##    Memory: 12gb
##   modifield by naga spurthi acharam on 3/28/2026 
###############################################
...
MyID=aubnsa001          ## Example: MyID=aubrmg001

WD=/scratch/aubnsa001/PracticeRNAseq                      ## Example:/scratch/$MyID/PracticeRNAseq  
CD=/scratch/aubnsa001/PracticeRNAseq/CleanData             ## Example:/scratch/$MyID/PracticeRNAseq/CleanData   #   *** This is where the cleaned paired files are located from the last script
REFD=/scratch/aubnsa001/PracticeRNAseq/corkoakRefGenome    ## Example:/scratch/$MyID/PracticeRNAseq/DaphniaRefGenome    # this directory contains the indexed reference genome for Daphnia
MAPD=/scratch/aubnsa001/PracticeRNAseq/Map_HiSat2           ## Example:/scratch/$MyID/PracticeRNAseq/Map_HiSat2      #
COUNTSD=/scratch/aubnsa001/PracticeRNAseq/Counts_StringTie       ## Example:/scratch/$MyID/PracticeRNAseq/Counts_StringTie
RESULTSD=/home/aubnsa001/PracticeRNAseq/Counts_H_S          ## Example:/home/aubtss/PracticeRNAseq/Counts_H_S

REF=CorkOak_RefSeq                   ## This is what the "easy name" will be for the genome reference
INDEX=CorkOak_index                  ##
...
hisat2-build --ss ${REF}.ss --exon ${REF}.exon ${REF}.fasta ${INDEX}
...
ls *_trimmed.fastq | sed 's/_trimmed.fastq$//' > list    #should list Example: SRR629651 modeifeid to SE ls *_trimmed.fastq finds the right filessed 's/_trimmed.fastq$//' removes that suffix
...
cp /home/aubnsa001/scripts/prepDE.py3 .
